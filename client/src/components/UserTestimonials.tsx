...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: "I found the perfect makeup artist for my wedding through Stylemate. The booking process was seamless and secure!",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Join thousands of satisfied customers who trust Stylemate for their beauty and wellness needs
          </p>
        </div>
