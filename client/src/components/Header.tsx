...
export default function Header() {
  ...
  const wishlistItemsCount = (wishlistData as any)?.wishlist?.length || 0;
          ...
          <Link href="/">
            <div className="flex items-center gap-2.5 cursor-pointer group">
              ...
              <div className="flex flex-col">
                <h1 className="text-xl font-bold tracking-tight bg-gradient-to-r from-gray-900 via-violet-900 to-gray-900 bg-clip-text text-transparent">Stylemate</h1>
                      ...
                      {!isAuthenticated && (
                        <>
                          ...
                          <Link href="/login" onClick={closeMobileMenu}>
                            <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-white bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-700 hover:to-fuchsia-700 transition-colors text-left font-medium shadow-lg shadow-violet-200/50">
                              <User className="h-4 w-4" />
                              <span>Log in</span>
                            </button>
                          </Link>
                          <Link href="/join" onClick={closeMobileMenu}>
                            <button className="w-full flex items-center gap-3 px-4 py-3 mt-2 rounded-xl text-violet-700 bg-violet-50 hover:bg-violet-100 transition-colors text-left font-medium border border-violet-200">
                              <User className="h-4 w-4" />
                              <span>Sign up</span>
                            </button>
                          </Link>
                          <Link href="/join/business" onClick={closeMobileMenu}>
                            <button className="w-full flex items-center gap-3 px-4 py-3 mt-2 rounded-xl text-gray-700 hover:bg-gray-50 transition-colors text-left">
                              <Sparkles className="h-4 w-4 text-gray-400" />
                              <span className="font-medium">List Your Studio</span>
                            </button>
                          </Link>
                        </>
                      )}
