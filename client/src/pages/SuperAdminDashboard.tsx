          ...
          <div className="flex items-center justify-between mb-6 px-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Stylemate</p>
              </div>
            </div>
            <Button
              variant="ghost"
...
function GeneralSettingsSection({ settings, onSave, isLoading }: { settings: any; onSave: (data: any) => void; isLoading: boolean }) {
  const [form, setForm] = useState({
    platformName: settings.platformName || 'Stylemate',
...
function BrandingSettingsSection({ settings, onSave, isLoading }: { settings: any; onSave: (data: any) => void; isLoading: boolean }) {
  const [form, setForm] = useState({
    ...
    footerText: settings.footerText || '© 2025 Stylemate. All rights reserved.',
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between p-4 border rounded-lg">
          <div>
            <p className="font-medium">Show "Powered by Stylemate"</p>
