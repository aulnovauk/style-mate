    ...
    >
      <CardContent className="p-0">
        ...
        <div className="p-6">
          ...
          >
            Get {getDiscountText()} via Stylemate
          </Button>
        </div>
      </CardContent>
    </Card>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
            ...
            <div className="flex items-start gap-8 text-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Book your appointment via the Stylemate app</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Pay bill with Stylemate to avail the offer</p>
                </div>
              </div>
            </div>
          </div>
