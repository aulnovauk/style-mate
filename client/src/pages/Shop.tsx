              ...
              >
                ...
                <div className="p-3 space-y-2">
                  <div>
                    ...
                    {product.salonName && (
                      <p className="text-xs text-primary font-medium">{product.salonName}</p>
                    )}
                    {product.brand && (
                    ...
                    <Button
                      ...
                      onClick={(e) => {
                        ...
                        addToCart({
                          id: product.id,
                          name: product.name,
                          retailPriceInPaisa: product.retailPriceInPaisa,
                          primaryImage: product.retailImages?.[0] || null,
                          salonId: product.salonId,
                          salonName: product.salonName || undefined,
                        });
                      }}
                    >
