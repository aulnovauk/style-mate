...
6. Contact Us
If you have questions about this Privacy Policy, please contact us at privacy@stylemate.in`;
...
By using Stylemate, you agree to these Terms of Service. If you do not agree, please do not use our services.

2. Services
Stylemate provides a platform connecting customers with salon and beauty service providers. We are not responsible for the quality of services provided by individual salons.
...
Stylemate is not liable for any indirect, incidental, or consequential damages arising from your use of our services.

9. Changes to Terms
We may update these terms from time to time. Continued use of the service constitutes acceptance of updated terms.

10. Contact
For questions about these Terms, contact us at legal@stylemate.in`;

const aboutUsContent = `About Stylemate

Stylemate is India's leading beauty services booking platform, connecting customers with the best salons and beauty professionals.
...
Our Story
Founded in 2024, Stylemate started with a simple idea: make booking beauty services as easy as ordering food online. Today, we serve thousands of customers across India, helping them discover and book the best salons in their area.
