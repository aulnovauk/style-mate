...
const SalonCardComponent: React.FC<SalonCardProps> = ({ salon, onPress }) => {
  ...
  const formatPriceRange = useCallback((range: string) => {
    const rupeeSymbol = '\u20B9';
      ...
      <View style={[styles.card, { width: CARD_WIDTH }]}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.tagsContainer}>
            ...
            {salon.hasPackages && (
              <View style={[styles.tagPink, styles.tagMargin]}>
...
function arePropsEqual(prevProps: SalonCardProps, nextProps: SalonCardProps): boolean {
  return (
    prevProps.salon.id === nextProps.salon.id &&
    prevProps.salon.name === nextProps.salon.name &&
    prevProps.salon.rating === nextProps.salon.rating &&
    prevProps.salon.reviewCount === nextProps.salon.reviewCount &&
    prevProps.salon.distance_km === nextProps.salon.distance_km &&
    prevProps.salon.image === nextProps.salon.image &&
    prevProps.salon.priceRange === nextProps.salon.priceRange &&
    prevProps.salon.category === nextProps.salon.category &&
    prevProps.salon.hasPackages === nextProps.salon.hasPackages &&
    prevProps.onPress === nextProps.onPress
  );
}

export const SalonCard = memo(SalonCardComponent, arePropsEqual);
