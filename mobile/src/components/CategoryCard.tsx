...
function arePropsEqual(prevProps: CategoryCardProps, nextProps: CategoryCardProps): boolean {
  return (
...
export const CategoryCard = memo(CategoryCardComponent, arePropsEqual);
