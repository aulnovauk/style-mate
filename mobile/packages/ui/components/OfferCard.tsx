...
const OfferCardComponent: React.FC<OfferCardProps> = ({ offer, onPress }) => {
  ...
  const gradientColors = isFirstOffer
    ...
    : ['rgba(236, 72, 153, 0.1)', 'rgba(139, 92, 246, 0.1)'] as const;
...
function arePropsEqual(prevProps: OfferCardProps, nextProps: OfferCardProps): boolean {
  return (
    ...
    prevProps.offer.badge === nextProps.offer.badge &&
    prevProps.offer.badgeColor === nextProps.offer.badgeColor &&
    prevProps.offer.icon === nextProps.offer.icon &&
    prevProps.offer.iconColor === nextProps.offer.iconColor &&
    prevProps.onPress === nextProps.onPress
  );
}

export const OfferCard = memo(OfferCardComponent, arePropsEqual);
