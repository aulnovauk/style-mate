...
export default function ReferralScreen() {
  ...
  const handleShare = async () => {
    ...
    try {
      await Share.share({
        message: `Join me on Stylemate and get ${referralCode.refereeRewardPoints} bonus points on your first booking! Use my referral code: ${referralCode.code}\n\nDownload the app now!`,
        title: 'Join Stylemate',
      });
    } catch (error) {
