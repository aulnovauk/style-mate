  ...
  const handlePermission = async (action: 'allow' | 'deny') => {
    ...
    try {
      ...
      if (status === 'granted') {
        ...
        // Get push token for later use (optional - don't fail if this doesn't work)
        try {
          ...
          if (projectId) {
            ...
            console.log('No projectId configured, skipping push token registration');
          }
        } catch (tokenError) {
      ...
      // Don't block the user - just continue to next screen
      await updatePermissions({ notifications: 'denied' });
      router.push('/onboarding/mobile-verification');
    } finally {
      ...
      <View style={styles.modalContainer}>
        <View style={styles.modal}>
          ...
          <Text style={styles.description}>
            Allow <Text style={styles.brandName}>Stylemate</Text> to send you notifications about
