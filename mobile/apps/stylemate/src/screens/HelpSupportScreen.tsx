...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Please contact our support team through this Help section or email us at support@stylemate.in. We will resolve your issue promptly.',
  },
];
...
export default function HelpSupportScreen() {
  ...
  const handleContactSupport = (method: string) => {
    switch (method) {
      case 'email':
        Linking.openURL('mailto:support@stylemate.in?subject=Support Request');
        break;
      case 'phone':
