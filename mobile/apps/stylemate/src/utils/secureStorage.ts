...
const STORAGE_KEYS = {
  ACCESS_TOKEN: 'stylemate_access_token',
  REFRESH_TOKEN: 'stylemate_refresh_token',
  USER: 'stylemate_user',
  ONBOARDING_COMPLETE: 'stylemate_onboarding_complete',
  PERMISSIONS: 'stylemate_permissions',
};
