...
const app = express();
// Trust proxy - required for secure cookies behind reverse proxies (Hostinger, Cloudflare, etc.)
// This ensures req.secure is true when the proxy forwards HTTPS requests
